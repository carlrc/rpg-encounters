...
<script setup>
  ...
  import { getEncounters, createEncounter, saveCanvas as saveCanvasAPI } from '../services/api'
  import { useGameDataStore } from '../stores/gameData'
  import { useWorldStore } from '../stores/world'
  import { usePlayerStore } from '../stores/players'
  import { useCharacterStore } from '../stores/characters'
  import { useNotification } from '../composables/useNotification'
  import { useEncounterGraphOps } from '../composables/encounters/useEncounterGraphOps'
  import { useEncounterCanvasData } from '../composables/encounters/useEncounterCanvasData'
  import { isTemporaryId } from '../utils/idUtils'
  import { saveViewport, getViewport } from '../utils/viewportState'
