...
class ConversationStore(BaseStore):
    ...
    async def create(self, conversation_data: ConversationCreate) -> Conversation:
        ...
        try:
            ...
            logger.error(
                f"Error creating conversation for user {self.user_id}, world {self.world_id}: {e}"
            )
            raise
    ...
    async def get(
        ...
        try:
            ...
            logger.error(
                f"Error getting conversation for user {self.user_id}, world {self.world_id}: {e}"
            )
            raise
    ...
    async def add_messages(
        ...
        try:
            ...
            logger.error(
                f"Error adding messages to conversation for user {self.user_id}, world {self.world_id}: {e}"
            )
            raise
    ...
    async def exists(
        ...
        try:
            ...
            logger.error(
                f"Error checking if conversation exists for user {self.user_id}, world {self.world_id}: {e}"
            )
            raise
    ...
    async def delete(
        ...
        try:
            ...
            logger.error(
                f"Error deleting conversation for user {self.user_id}, world {self.world_id}: {e}"
            )
            raise
