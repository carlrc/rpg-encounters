...
def test_ship_encounter_character_and_player_assignments():
    expected = {
        "The Upper Deck": {"character_ids": [5, 3], "player_ids": [1]},
        "The Main Deck": {"character_ids": [1], "player_ids": [0]},
        "The Captain's Quarters": {"character_ids": [0], "player_ids": []},
        "The Hold": {"character_ids": [6], "player_ids": [4]},
        "The Crew Quarters": {"character_ids": [3, 4], "player_ids": [2]},
        "The Lower Deck": {"character_ids": [2], "player_ids": [3]},
    }
