...
from tests.utilities import verify_nugget_content_availability

NUGGET_LEVEL_1 = (
    "I've been running this tavern for over twenty years and know everyone in town."
)
...
async def run_trust_test(
    character: Character,
    player: Player,
    earned_trust: float,
    test_nugget: TrustNugget,
    chat_message: str,
    expected_available: list,
    expected_conditional: list,
    expected_unavailable: list,
):
