...
characters_db = {
    1: Character(
        ...
        race_preferences={
            ...
            Race.HIGH_ELF.value: -DifficultyClass.VERY_EASY.value,
            Race.HILL_DWARF.value: -DifficultyClass.VERY_EASY.value,
            Race.DRAGONBORN.value: -DifficultyClass.VERY_EASY.value,
            Race.FOREST_GNOME.value: -DifficultyClass.VERY_EASY.value,
            Race.HALF_ELF.value: -DifficultyClass.VERY_EASY.value,
