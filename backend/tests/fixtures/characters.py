...
characters_db = [
  ...
  CharacterCreate(
    ...
    background="A noble woman from Waterdeep, whose family seeks to gain the favour of the Waterdhavian houses.",
    motivation="She is fiercely loyal to the council of lords in Waterdeep and will do anything to succeed.",
