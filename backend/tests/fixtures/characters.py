...
characters_db = {
    1: Character(
        ...
        race_preferences={
            CharacterRace.HALFLING.value: DifficultyClass.VERY_EASY.value,
            CharacterRace.HUMAN.value: -DifficultyClass.VERY_EASY.value,
            CharacterRace.ELF.value: -DifficultyClass.VERY_EASY.value,
            CharacterRace.DWARF.value: -DifficultyClass.VERY_EASY.value,
            CharacterRace.DRAGONBORN.value: -DifficultyClass.VERY_EASY.value,
            CharacterRace.GNOME.value: -DifficultyClass.VERY_EASY.value,
            CharacterRace.HALF_ELF.value: -DifficultyClass.VERY_EASY.value,
            CharacterRace.HALF_ORC.value: -DifficultyClass.VERY_EASY.value,
            CharacterRace.TIEFLING.value: -DifficultyClass.VERY_EASY.value,
        },
